    ...
    const referencias = [
        {
            ...
            https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6733216/ . Acesso em: 16 maio 2020`
        },
        {
            ...
            stic_Organ.21.aspx . Acesso em: 16 maio 2020.`
        },
        {
            autor: `Open Pediatrics`,
            titulo: `PEDIATRIC INDEX OF MORTALITY 2`,
            complemento: `Estima o risco de mortalidade no ambiente de
            terapia intensiva pediátrica. Disponível em: https://www.openpediatrics.org/assets/calculator/pediatric-index-mortality-2 . Acesso em: 02 maio 2020.`
        },
        {
            ...
            https://sfar.org/scores2/pelod2.php#haut. Acesso em: 5 de junho de 2020`
        },
        {
            autor: `SLATER, Anthony; SHANN, Frank; PEARSON, Gale`,
            titulo: `PIM2: a revised version of the Paediatric Index of
            Mortality`,
            complemento: `Disponível em: https://link.springer.com/article/10.1007/s00134-002-1601-2 . Acesso em: 16 maio
            2020`
        },
    ];
